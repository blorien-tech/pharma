        ...
        <div class="bg-white rounded-lg shadow-md p-6 space-y-6">
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p class="text-sm text-yellow-800">
                    <strong>Note:</strong> This customer has an outstanding balance of ৳{{ number_format($customer->current_balance, 2) }}.
                    Disabling credit is not recommended until balance is cleared.
                </p>
            </div>
            @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="credit_limit" id="credit_limit" step="0.01" min="0"
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-3 py-2 border">
                    <p class="mt-1 text-xs text-gray-500">Current balance: ৳{{ number_format($customer->current_balance, 2) }}</p>
                </div>
            </div>
        </div>
