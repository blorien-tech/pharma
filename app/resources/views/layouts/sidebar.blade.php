        ...
        <ul class="space-y-1 px-3">
            ...
            <li>
                <a
                    ...
                    class="flex items-center space-x-3 px-3 py-3 rounded-lg transition {{ request()->routeIs('locations.*') ? 'bg-blue-700 shadow-md' : 'hover:bg-blue-700/50' }}"
                    :title="collapsed ? '{{ __('navigation.locations') }}' : ''"
                >
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                    <span x-show="!collapsed" class="font-medium" x-transition>{{ __('navigation.locations') }}</span>
                </a>
            </li>
